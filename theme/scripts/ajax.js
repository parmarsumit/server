(function ($) {
    ...
    if( app.setting.ajax ){
      ...
      var main_pjax = new Pjax({
        cacheBust: false,
        elements: '#aside a:not(.no-ajax), #content-header a:not(.no-ajax), #nav a:not(.no-ajax), .app-header a:not(.no-ajax)',
      ...
      var sub_pjax = new Pjax({
        cacheBust: false,
        elements: '#content-aside a:not(.no-ajax), #content-body a:not(.no-ajax)',
